            ...
            <div class="content-wrapper">
                <nav class="navbar bg-body-tertiary" style="z-index: 1">
                    <div class="container-fluid">
                        <a class="navbar-brand ps-2 " data-bs-toggle="collapse" data-bs-target="#sideBar"
                           aria-controls="offcanvasScrolling" href="#">
                            <svg style="color: #1a202c" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                 fill="currentColor" class="bi bi-list" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                      d="M2.5 12a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5z"/>
                            </svg>
                        </a>
                        <a class="float-end" href="/logout">
                            <svg style="color: #1a202c" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <aside>
                    <div class="offcanvas offcanvas-start overflow-auto"
                         style="top:56px; z-index: 2; width: 190px; position: absolute" data-bs-backdrop="static"
                         id="sideBar"
                         aria-labelledby="staticBackdropLabel">
                        <ul class="nav flex-column ">

                            <li class="nav-item p-2  border border-1 ">
                                <router-link class="nav-link active" aria-current="page" to="/painel">
                            ...
                            <li class="nav-item p-2  border border-1">
                                <router-link class="nav-link active" aria-current="page" to="/categorias/index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item p-2  border border-1">
                                ...
                                <router-link class="nav-link active" aria-current="page" to="/contatos/index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item p-2  border border-1">
                                ...
                                <router-link class="nav-link active" aria-current="page" to="/servicos/index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                         class="bi bi-file-person-fill" viewBox="0 0 16 16">
                                        <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm-1 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm-3 4c2.623 0 4.146.826 5 1.755V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1v-1.245C3.854 11.825 5.377 11 8 11z"/>
                                    </svg>
                            ...
                            <li class="nav-item p-2  border border-1">
                                <router-link class="nav-link active" aria-current="page" to="/aliquotas/index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item p-2  border border-1">
                                ...
                                <router-link class="nav-link active" aria-current="page" to="/users/index">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            ...
                            <li class="nav-item p-2  border border-1">
                                <a class="nav-link active" @click="goConfig" aria-current="page" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
