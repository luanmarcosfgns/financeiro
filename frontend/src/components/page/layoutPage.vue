                        ...
                        <ul class="nav flex-column ">
                            ...
                            <li class="nav-item p-2  border border-1 ">
                                <router-link aria-current="page" class="nav-link active" to="/painel">
                                    <svg class="bi bi-bar-chart-line-fill" fill="currentColor" height="16" viewBox="0 0 16 16"
                            ...
                            <li class="nav-item p-2  border border-1">
                                ...
                                <router-link aria-current="page" class="nav-link active" to="/contatos/index">
                                    <svg class="bi bi-file-person-fill" fill="currentColor" height="16" viewBox="0 0 16 16"
                                         width="16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item p-2  border border-1">
                                <router-link aria-current="page" class="nav-link active" to="/categorias/index">
                                    <svg class="bi bi-ticket-detailed-fill" fill="currentColor" height="16" viewBox="0 0 16 16"
                                         width="16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item p-2  border border-1">
                                <router-link aria-current="page" class="nav-link active" to="/aliquotas/index">
                                    <svg class="bi bi-percent" fill="currentColor" height="16" viewBox="0 0 16 16"
                                         width="16" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item p-2  border border-1">
                                ...
                                <router-link aria-current="page" class="nav-link active" to="/users/index">
                                    <svg class="bi bi-file-earmark-lock2-fill" fill="currentColor" height="16" viewBox="0 0 16 16"
                                         width="16" xmlns="http://www.w3.org/2000/svg">
