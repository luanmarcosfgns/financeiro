    ...
    methods: {
        async sendForm() {
            ...
            let dataForm = {
                ...
                porcentagem_seguradora: document.getElementById('porcentagem_seguradora').value,
                porcentagem_franquiadora: document.getElementById('porcentagem_franquiadora').value,
                porcentagem_maxima_vendedor: document.getElementById('porcentagem_maxima_vendedor').value,
                porcentagem_minima_vendedor: document.getElementById('porcentagem_minima_vendedor').value,
