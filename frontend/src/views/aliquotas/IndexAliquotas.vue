...
export default {
    ...
    methods: {
        async list() {
            ...
            let dataRow = await requestHelper.getAuth(process.env.VUE_APP_API_HOST_NAME + '/api/aliquotas', dataRequest);
        ...
        async deleteRow(id) {
            let requestHelper = new RequestHelper();
            let dataRow = await requestHelper.deleteAuth(process.env.VUE_APP_API_HOST_NAME + '/api/aliquotas/' + id);
